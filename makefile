...
MAIN_PDF=$(MAIN).pdf
MAIN_TEX=$(MAIN).tex
HELPER_FILES=makefile thesis.bib mnthesis.cls variables.tex
...
$(MAIN_PDF): force $(MAIN_TEX) $(HELPER_FILES) $(CHAPTERS) $(FIGURES) $(PACKAGED_FIGURES) $(QCD_FIGURES) $(TABLES) $(MACROS)
