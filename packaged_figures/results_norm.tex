...
\begin{figure}[!htbp]
    ...
    \caption[
        Close up of the ratio plot from \FIG~\ref{fig:result_norm} for the
        normalized cross section measurement.
    ]{
        Close up of the ratio plot from \FIG~\ref{fig:result_norm} for the
        normalized cross section measurement. The error band indicates the
