...
\input{packaged_figures/data_uncertainty_normalized_powheg_unfolded.tex}
...
agrees better with the data unfolded with \POWHEG, and not just because the
...
underestimate the cross section by \SI{10}{\percent} in the low \phistar
region, \SI{15}{\percent} in the high \phistar region, and overestimates the
cross section by \SI{10}{\percent} in the intermediate region. In fact \POWHEG
is only consistent with the data in five bins, although four of these are
grouped together around $\phistar \approx 0.15$. \POWHEG does equally poorly
when compared with the data unfolded with \POWHEG.
