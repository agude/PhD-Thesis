...
many of them must be ``tuned'' to best fit the data. One such example of tuned
parameters are the various PDF inputs, which theory groups generally produce by
