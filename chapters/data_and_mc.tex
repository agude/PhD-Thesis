...
luminosity during the year as seen in \cref{fig:2012_luminosity}. This
...
and \PYTHIAsix \cite{sjostran2006}, as indicated in \cref{table:mc}. All of the samples use
\PYTHIAsix for the underlying event and hadronization. \TODO{Use version numbers.}
...
\cref{sec:electron_reconstruction}. The efficiency of an electron with $\pt
