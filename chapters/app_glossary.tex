...
\GlossaryEntry{Background sample}{The MC samples simulating the various backgrounds to the analysis, for example, \ttbar.}
...
\GlossaryEntry{Monte Carlo (MC)}{Simulated data. See \cref{sec:mc}.}
...
\GlossaryEntry{Signal Sample}{The MC samples simulating the signal (\DYtoee) that this analysis looks for, as opposed to background samples.}
\GlossaryEntry{Simulation}{See \textit{Monte Carlo}.}
\GlossaryEntry{Toy Monte Carlo}{A highly simplified Monte Carlo sample.}
...
\AcronymEntry{RPC}{Resistive plate chambers}
\AcronymEntry{SLAC}{Stanford Linear Accelerator Center}
