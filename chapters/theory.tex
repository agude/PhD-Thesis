...
measurement with \Ztomumu decays instead. A few common decay modes and their
branching fraction are listed in \TAB~\ref{table:z_decays}.
...
MSTW collaboration\cite{martin_2009} is shown in \FIG~\ref{fig:mstw_pdf}. In
...
unfolding as discussed in \CHP~\ref{sec:unfolding}, \dressed electrons are
used.
