...
The \Z boson is an excellent probe of precision physics as its well
...
% table:z_decays
\include{tables/z_decay_modes.tex}
...
beamline, the \pt of the \Z boson comes from QCD process like initial state
radiation, which are discussed in \SEC~\ref{ssec:higher_order}.
...
the \BjorkenX{i} variables of the incoming partons, is:
