...
efficiency, and the trigger efficiency. The calculations of these efficiencies
are discussed in detail in \SECS~\ref{ssec:sf_reconstruction},
\ref{ssec:sf_id}, and \ref{ssec:sf_trigger}.
...
sample discussed in \SEC~\ref{ssec:monte_carlo}. \TODO{Expand after talking to
Nicole.}
