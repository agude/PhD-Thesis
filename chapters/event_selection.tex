...
% fig:e_pt
\input{packaged_figures/e_pt.tex}
% fig:e_eta
\input{packaged_figures/e_eta.tex}
...
%fig:z_mass
\input{packaged_figures/z_mass.tex}
%fig:z_mass_powheg
\input{packaged_figures/z_mass_powheg.tex}
%fig:z_pt
\input{packaged_figures/z_pt.tex}
%fig:z_pt_powheg
\input{packaged_figures/z_pt_powheg.tex}
%fig:z_rapidity
\input{packaged_figures/z_rapidity.tex}
%fig:z_rapidity_powheg
\input{packaged_figures/z_rapidity_powheg.tex}
...
bosons produced in association another weak boson as a background because of
their different production mechanism as opposed to single \Z boson events. The
