...
The distribution of electron \pt and $\eta$ are show in \FIGS~\ref{fig:e_pt}
and \ref{fig:e_eta}.
...
\begin{figure}[tb]
    ...
    \end{minipage}
    \caption{
        The \pt distribution of the higher and lower \pt electrons for events
        passing the full analysis selection is shown on the left and right
        plots, respectively.
    }
    \label{fig:e_pt}
\end{figure}
...
\begin{figure}[tb]
    ...
    \end{minipage}
    \caption{
        The $\eta$ distribution of the higher and lower \pt electrons for
        events passing the full analysis selection is shown on the left and
